import { Layout, User, Calendar, Dumbbell, CalendarDays, Star, BadgeDollarSign, MessageCircleMoreIcon } from "lucide-react"
...
export const menuItems: MenuItem[] = [
    ...
    { id: 8, text: "Atendimento", path: "/chat", icon: <MessageCircleMoreIcon size={30} className="mr-3" /> },
]